...
public class Main {
    ...
    public static void main(String[] args) {      
        ...
        // Crea il controller della simulazione
        SimulationController controller = new SimulationController(model);

        // Ottieni il simulator dal controller
        var simulator = controller.getSimulator();
        
        // Avvia la simulazione
        simulator.start();
        
        // Collega la GUI al controller
        BoidsView view = new BoidsView(model, simulator, controller, SCREEN_WIDTH, SCREEN_HEIGHT);
    }
}
